<!--
   You're reading raw source. Most people don't. Since you're already here:

       ┌──────────────┐
       ╲              ╱   >_ a wild recruiter opens View Source
...
**[Terrarium](https://github.com/cypher-30/Terrarium)** — a zero-player philosophical simulation.
Agents wander a canvas carrying an Essence (life force) and Friction (accumulated dissatisfaction)
value; enough Friction triggers a paradigm shift into a new philosophical faction, zero Essence kills
them. Ten factions (Stoic, Machiavellian, Absurdist, Hobbesian, Sisyphus, and others), an Owner/Worker
class struggle with revolts, theological events, and a live Gini coefficient tracking essence
inequality across the population. There is no player goal. You just watch it happen.
...
<picture>
  ...
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/cypher-30/cypher-30/output/github-contribution-grid-snake.svg" />
